...
* Pulling and saving container images
   ...
   docker.io/quay.io/dell/container-storage-modules/dell-csm-operator:v1.3.0
...
Loaded image: docker.io/quay.io/dell/container-storage-modules/csi-powerstore:v2.12.0
Loaded image: docker.io/quay.io/dell/container-storage-modules/csi-isilon:v2.12.0
...
...
...
* Tagging and pushing images
   ...
   quay.io/dell/container-storage-modules/csi-metadata-retriever:v1.7.2 -> localregistry:5000/dell-csm-operator/csi-metadata-retriever:v1.7.2
   ...
   ...
...
* Preparing files within /root/dell-csm-operator-bundle
   ...
   changing: quay.io/dell/container-storage-modules/csi-metadata-retriever:v1.7.2 -> localregistry:5000/dell-csm-operator/csi-metadata-retriever:v1.7.2
   ...
   ...
